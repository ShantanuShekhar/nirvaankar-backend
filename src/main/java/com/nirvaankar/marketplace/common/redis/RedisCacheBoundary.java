 ...
 * <p>
 * Callers treat {@link OptionalLong#empty()} / {@code false} as "cache missed
 * because Redis is unavailable" and fall through to the database. Auth, OTP
 * and rate-limit <em>decisions</em> never live only in Redis.
 * <p>
